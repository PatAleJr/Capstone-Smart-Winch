...
class Ui_mw_Main(object):
    def setupUi(self, mw_Main):
        ...
        self.gb_cord_recommendations.setMinimumSize(QSize(400, 0))
        ...
        self.lb_recommended_anchor_offset.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)

        self.gridLayout_5.addWidget(self.lb_recommended_anchor_offset, 1, 2, 1, 1)
        ...
        self.lb_recommended_anchor_offset_value = QLabel(self.gb_cord_recommendations)
        self.lb_recommended_anchor_offset_value.setObjectName(u"lb_recommended_anchor_offset_value")
        sizePolicy4.setHeightForWidth(self.lb_recommended_anchor_offset_value.sizePolicy().hasHeightForWidth())
        self.lb_recommended_anchor_offset_value.setSizePolicy(sizePolicy4)
        self.lb_recommended_anchor_offset_value.setFont(font2)
        self.lb_recommended_anchor_offset_value.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)

        self.gridLayout_5.addWidget(self.lb_recommended_anchor_offset_value, 1, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.pb_request_recommendation, 0, 0, 1, 4)
        ...
        sizePolicy4.setHeightForWidth(self.lb_current_anchor_offset.sizePolicy().hasHeightForWidth())
        self.lb_current_anchor_offset.setSizePolicy(sizePolicy4)
        font4 = QFont()
        ...
        sizePolicy6.setHeightForWidth(self.le_custom_anchor_offset.sizePolicy().hasHeightForWidth())
        self.le_custom_anchor_offset.setSizePolicy(sizePolicy6)
        ...
        sizePolicy4.setHeightForWidth(self.lb_current_anchor_offset_value.sizePolicy().hasHeightForWidth())
        self.lb_current_anchor_offset_value.setSizePolicy(sizePolicy4)
        ...
        sizePolicy7.setHeightForWidth(self.pb_jump.sizePolicy().hasHeightForWidth())
        self.pb_jump.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.tb_similar_jumps.sizePolicy().hasHeightForWidth())
        self.tb_similar_jumps.setSizePolicy(sizePolicy8)
        ...
        sizePolicy9.setHeightForWidth(self.gb_todays_jump_history.sizePolicy().hasHeightForWidth())
        self.gb_todays_jump_history.setSizePolicy(sizePolicy9)
    ...
    def retranslateUi(self, mw_Main):
        ...
        self.lb_recommended_anchor_offset.setText(QCoreApplication.translate("mw_Main", u"Anchor Offset:", None))
        self.lb_recommended_cord.setText(QCoreApplication.translate("mw_Main", u"Use cord:", None))
        self.lb_recommended_anchor_offset_value.setText(QCoreApplication.translate("mw_Main", u"12' 5\"", None))
