...
class Ui_mw_Main(object):
    ...
    def retranslateUi(self, mw_Main):
        ...
        self.lb_weight.setText(QCoreApplication.translate("mw_Main", u"Weight", None))
        self.lb_weight_value.setText(QCoreApplication.translate("mw_Main", u"150 lb", None))
        self.lb_height.setText(QCoreApplication.translate("mw_Main", u"Height", None))
